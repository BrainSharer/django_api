...
class Histology(AtlasModel):
    ...
    orientation = EnumField(choices=['coronal','horizontal','sagittal','oblique'], blank=False, null=False, default='sagittal')
    side_sectioned_first = EnumField(choices=SideSectionedFirstChoices,  blank=False, null=False, default=SideSectionedFirstChoices.LEFT)
